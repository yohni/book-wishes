...
const Navbar = () => {
  ...
  return (
    <div className="fixed inset-0 md:inset-x-0 md:top-0 md:bottom-auto md:bg-neutral">
      ...
      <div
        className={`absolute md:h-auto inset-x-0 md:left-auto top-0 md:bottom-0 h-0 bg-neutral md:bg-transparent duration-300 transition-all z-10 md:z-20 flex justify-center items-center text-white md:mr-2 md:pr-2 ${
          isOpen && 'h-screen'
        }`}
      >
